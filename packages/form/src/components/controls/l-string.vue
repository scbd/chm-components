<template>
    <div class="form-group TextInput" :class="{ 'has-error': !!(errorMessage && meta.touched), success: (meta.valid && meta.touched) }" >
...
//initial value come from form. ... need to handle prop setting
  ...
  return { t, handleChange, handleBlur, errorMessage, inputValue, meta, locale, computedLabel };
}

//function created(){ this.$watch('value', (value) => { this.inputValue = value }) } 
